...
description: "Analyze Azure resources and IaC to identify cost optimizations, estimate savings, and optionally create tracking issues. Use when users ask about Azure cost reduction, spending analysis, or optimization opportunities."
---
