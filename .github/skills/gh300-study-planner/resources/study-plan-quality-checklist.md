...
- Each area has objective-level focus guidance.
- Each area has two to three Microsoft Learn links.
- Total study-hour range is included.
- Plan ends with a prompt to start practice.
