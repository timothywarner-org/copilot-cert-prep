...
- **Describe instructions for creating, managing, and searching Knowledge Bases within GitHub Copilot Enterprise**
  - Including details on indexing and other relevant configuration steps
...
- **Describe the different types of input processing for GitHub Copilot Chat**
  - Types of prompts it was designed for
...
- **Describe the age of code suggestions**
  - How old and relevant the data is
